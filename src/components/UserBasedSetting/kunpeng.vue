    ...
    <el-col :span="24" class="warp-main" v-loading="loading" element-loading-text="拼命加载中">
      ...
      <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
        <el-form :inline="true" :model="filters">
          ...
          <el-form-item>
            <el-button v-if="this.$global.haveUserPermissionNotRole('/kunpengBussiness/edit')" type="primary" v-on:click="showAddDialog">新建</el-button>
          </el-form-item>
        </el-form>

         <el-form :inline="true" :model="filters">  
          <el-form-item>
            <el-button v-if="this.$global.haveUserPermissionNotRole('/kunpengBussiness/edit')" type="text" @click="showAddDialogCity"> >添加新城市</el-button>
          </el-form-item>
          <el-form-item>
            <el-button  v-if="this.$global.haveUserPermissionNotRole('/kunpengBussiness/edit')" type="text" @click="showAddDialogCompany"> >添加新公司</el-button>
          </el-form-item>
          <el-form-item>
            <el-button v-if="this.$global.haveUserPermissionNotRole('/kunpengBussiness/edit')" type="text" @click="showAddDialogCartype"> >添加新车型</el-button>
          </el-form-item>
      ...
      <el-table-column prop="ordertime" label="下单时间" ></el-table-column>
       ...
       <!--
        ...
        <el-pagination layout="prev, pager, next" @current-change="handleCurrentChange" :page-size="10" :total="total"
            ...
            <el-button v-if="this.$global.haveUserPermissionNotRole('/kunpengBussiness/excelE')" type="primary" v-on:click="exportExcel('date')" style="float:right;position:relative">导出excel</el-button>
            ...
            <el-button v-if="this.$global.haveUserPermissionNotRole('/kunpengBussiness/excelE')" type="primary" v-on:click="exportExcel('')" style="float:right;right:30px">导出所有excel</el-button>
